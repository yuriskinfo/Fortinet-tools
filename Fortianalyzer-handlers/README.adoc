...
link:Admin-login-failed.json[Admin-level user login failed]

link:Admin-user-was-locked-out.json[Host was locked out due to multiple failed admin logins]

link:Sensitive-admin-user-logged-in.json[Sensitive admin-level user logged in]
