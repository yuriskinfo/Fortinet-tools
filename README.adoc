...
that it will work on your gear, and cannot predict all possible outcomes, so test before using in production. All stitches were tested on FortiOS 7.09.x and 7.2.x, and should work as is on 7.4.x as well.
