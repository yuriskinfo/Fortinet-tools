...
link:admin-login-failed.adoc[Failed admin-level user log in email alert]

link:admin-user-was-locked-out.adoc[Admin access locked out for multiple log in failures email alert]

link:sensitive-admin-user-logged-in.adoc[Sensitive/specific admin logged in email alert]
...
link:configuration-in-sys-admin-section-changed-by-with-changes-email-alert.adoc[Send alert on Fortigate configuration changed in system -> admin section by administrator with details]
